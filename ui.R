...
shinyUI(pageWithSidebar(
  headerPanel("Next Word Predictor",windowTitle = "NEXT WORD PREDICTOR"),
  sidebarPanel(
    h3("User Input"),
    br(),
    
    strong(""),
    textInput("text1", "Enter your text below:", value = "Hey Man whats up"),
    br(),

    selectInput("words1", "Maximum no of predicted words",
    ...
    strong("Click on GO button to return the predicted words."),
    br(),
    br(),
    actionButton("button1", "GO!",width="385px",icon=icon("list-alt"))
  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel("Prediction",
               ...
               h4('The words predicted based on the input text:'),
               tableOutput("table1")
